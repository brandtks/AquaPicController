    ...
    public class MyBackgroundWidget : Fixed
    {
        ...
        public MyBackgroundWidget (Window parent) {
            ...
            for (int i = 0; i < buttons.Length; ++i) {
                ...
                this.buttons [i].TouchButtonReleasedHandler += onButtonTouch;
        ...
        protected void onButtonTouch (object sender, ButtonReleaseEventArgs args) {
            ...
            if (string.Compare (b.Text, parent.Title, StringComparison.InvariantCultureIgnoreCase) != 0) {
                switch (b.Text) {
                case "Main":
                    parent.Dispose ();
                ...
                case "Power":
                    parent.Dispose ();
                    powerWindow powerScreen = new powerWindow ();
                    powerScreen.Show ();
                    break;
                default:
                    break;
