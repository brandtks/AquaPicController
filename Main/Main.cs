...
namespace AquaPic
{
    class MainClass
    {
        public static void Main (string[] args) {
            ...
            Driver.AnalogInput.SetChannelValue ("Return Chamber, Water Level Sensor", 1802);
            ...
            Driver.AnalogInput.SetChannelValue ("Return Chamber Lower, Water Level Sensor", 1146);
